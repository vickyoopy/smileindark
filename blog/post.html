...
<script type="text/javascript">
	$.backstretch("style/images/1.jpg");
</script>
</head>
			...
			<div id="menu" class="menu">
				<ul id="tiny">
					...
					<li class="active"><a href="index.html">Blog</a>
						<ul>
							<li><a href="comment.html">Message board</a></li>
							<li><a href="comment.html">Submit article</a></li>
						</ul>
					</li>
...
<div class="content">
		...
		<div id="comment-form" class="comment-form">
			<div id="respond">
						<h3 id="reply-title">Leave messages/suggestions/comments here.</h3>
